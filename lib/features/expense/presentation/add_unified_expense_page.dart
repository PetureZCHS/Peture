        ...
        children: [
          IconButton(
            icon: const Icon(Icons.close_rounded,
                size: 28, color: Color(0xFF1C1C1E)),
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isSelected ? Color(cat.color) : const Color(0xFFF2F2F7),
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Icon(
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 11,
                  color:
                      isSelected ? Color(cat.color) : const Color(0xFF8E8E93),
        ...
        children: [
          Expanded(
            ...
            child: Column(
              children: [
                Expanded(
                    child: Row(children: [_kBtn('7'), _kBtn('8'), _kBtn('9')])),
                Expanded(
                    child: Row(children: [_kBtn('4'), _kBtn('5'), _kBtn('6')])),
                Expanded(
                    child: Row(children: [_kBtn('1'), _kBtn('2'), _kBtn('3')])),
                Expanded(
                    child: Row(children: [
                  _kBtn('.'),
                  _kBtn('0'),
                  _kBtn('DEL', icon: Icons.backspace_outlined)
                ])),
              ],
            ),
          ),
