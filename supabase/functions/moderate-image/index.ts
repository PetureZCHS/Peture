...
import { isValidScene, MODERATION_ERROR_CODES } from "../_shared/moderation_contract.ts";
...
Deno.serve(async (req)=>{
  ...
  try {
    ...
    const moderation = await executeImageModeration(scene, imageBase64, storagePath, traceId);
